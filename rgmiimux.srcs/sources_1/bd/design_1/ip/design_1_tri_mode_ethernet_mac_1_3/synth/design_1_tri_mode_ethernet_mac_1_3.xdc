...
set_max_delay -from [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/tx_pause/count_set*reg}] 32 -datapath_only
set_max_delay -from [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/tx_pause/pause_count*reg[*]}] 32 -datapath_only
set_max_delay -from [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/rx_pause/pause_req_to_tx_int_reg}] -to [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/flow/tx_pause/sync_good_rx/data_sync_reg0}] 6 -datapath_only
...
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/sync_*tx_clk/sync_rst1_reg}] -to [get_cells {*/data_sync_reg0}]



set_max_delay -from [get_cells {design_1_tri_mode_ethernet_mac_1_3_core/sync_int_tx_rst_mgmt_tx_clk/sync_rst1_reg}] -to [get_cells {enable_gen/reset90gen/data_sync_reg0}] 6 -datapath_only
